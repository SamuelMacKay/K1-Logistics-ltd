...
| ------------- | ------------- | ------------- |
|1|<font color="green">Test Pass</font> |As the #, <br> I want # <br> so that # <br><br> I know I am done when # <br><br>Evidence:<br><br> ![]()|
|2|*<font color="yellow">Test Pass, more required</font>*|As the #, <br> I want # <br> so that # <br><br> I know I am done when # <br><br>Evidence:<br><br> ![]()|
|3|<font color="green">Test Pass</font> |As the #, <br> I want # <br> so that # <br><br> I know I am done when # <br><br>Evidence:<br><br> ![]()|
|4|<font color="green">Test Pass</font> |As the #, <br> I want # <br> so that # <br><br> I know I am done when # <br><br>Evidence:<br><br> ![]()|
|5|<font color="green">Test Pass</font> |As the #, <br> I want # <br> so that # <br><br> I know I am done when # <br><br>Evidence:<br><br> ![]()|
...
| Shipping |
| ------- |
| ![lighthouse result shipping page]() |

| Storage |
| ------- |
| ![lighthouse result storage page]() |

## Deployment

### Cloning & Forking
#### Fork
1. On GitHub.com, navigate to the [SamuelMacKay/K1-Logistics-ltd](https://github.com/SamuelMacKay/K1-Logistics-ltd) repository.
